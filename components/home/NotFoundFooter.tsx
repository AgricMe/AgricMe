...
const Footer = () => {
	return (
		<section
			id="contact"
			className="footer bg-[#fff] w-full flex flex-col px-[1.5rem] md:px-[3rem] lg:px-[4rem]">
				...
				<div className="hidden lg:flex relative w-full h-full">
					...
					<article className="p-[30px] col-span-1">
						<div style={{ alignItems: 'center' }}>
							<Image src="/logo/agricme-logo.png" alt="logo" width={160} height={36.91} />
						</div>
						<div
							style={{
								textAlign: 'center',
							...
							AgricMe stands as an innovative and purpose-driven agricultural social platform, meticulously
							designed to revolutionize farmer interactions and trade within the agricultural sector.
						</div>
						<h3 className="agri">
				...
				<div className="lg:hidden relative w-full h-full">
					...
					<article className="lg:p-[30px] col-span-1">
						...
						<div
							...
							Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fuga dolorem rem voluptatum magnam
							maiores, earum, magni culpa quas ad.
						</div>
						<h3 className="agri">
							<span className="agri1">
								<FaInstagramSquare className="iconfoot" />
