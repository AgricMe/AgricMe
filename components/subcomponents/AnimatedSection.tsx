...
const AnimatedSection = () => {
    ...
    return (
        <div className='first-sec-cont'>
            <section className={`shown-sec ${isVisible ? 'visiblesec' : 'invisiblesec'}`}>
                <Image
            ...
            <section className={`shown-sec2 ${isVisible ? 'visiblesec' : 'invisiblesec'}`}>
            ...
            <section className={`hidden-sec ${isVisible ? 'visiblesec' : 'invisiblesec'}`}>
                <Image
            ...
            <section className={`hidden-sec2 ${isVisible ? 'visiblesec' : 'invisiblesec'}`}>
                <article className="topp">
                    <span style={{ fontSize: "24px" }}>About Us</span>
