...
const UploadPost = () => {
  return (
    <div
      className="w-full h-[100px] bg-[#F9F8F8]"
      style={{
        height: "100px",
        ...
        <div className="flex items-center gap-10 w-full">
          ...
          <div className="w-full">
            <input
              ...
              className="input border-slate-300 bg-white h-9 w-full focus:border-slate-400 focus:outline-none"
            />
          </div>
        </div>
        <div className="flex items-center justify-center gap-4 md:gap-7 mt-3">
          <div>
            <label
              htmlFor="image"
