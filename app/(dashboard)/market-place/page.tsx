...
import UploadGoodsModal from "@/components/dashboard/uploadGoods";
    ...
    <>
      ...
      <section className="pb-10 px-1">
        ...
        <div className="bg-[#eff6f1] min-h-screen py-8 px-4 md:px-8 lg:px-[3.5rem]">
          ...
          <div
            className={`flex justify-start items-center py-2.5 px-1.5 md:px-4 bg-green-600 rounded-md cursor-pointer mb-8`}
            onClick={() => setIsOpen(true)}
          >
            <h3
              className={`text-[.8rem] md:text-[.95rem] text-[#fff] font-normal ${cursive.className}`}
            >
            ...
            {!grid && (
              <div className="hidden md:flex flex-col w-[30vw]">
                ...
                <div className="flex gap-2 mb-3">
                  ...
                  <p className="text-gray-400 font-normal text-[.8rem]">
                    (234)
                  </p>
                </div>
                <div className="flex gap-2 mb-3">
